...
import com.practicum.playlistmaker.databinding.PlaylistItemLinearBinding
...
class PlaylistsAdapter(
    ...
    inner class ViewHolder(val binding: PlaylistItemLinearBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaylistsAdapter.ViewHolder {
        val binding =
            PlaylistItemLinearBinding.inflate(LayoutInflater.from(parent.context), parent, false)
